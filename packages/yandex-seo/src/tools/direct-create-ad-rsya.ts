...
type AdRsyaInput = z.infer<typeof InputSchema>;

function buildAdPayload(input: AdRsyaInput): Record<string, unknown> {
...
export async function runDirectCreateAdRsya(input: AdRsyaInput) {
